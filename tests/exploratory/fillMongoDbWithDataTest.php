...
final class fillMongoDbWithDataTest extends TestCase
{
    ...
    private string $title = 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit';
     ...
     */
    public function insertPostsInDatabase()
    {
        $target = new PostsRepository($this->dm);

        /*foreach(range(0,20000) as $i) {
            $input = new Post($this->body . $i, $this->title . $i);
